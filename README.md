...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-webdriver-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-webdriver-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-webdriver-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-webdriver-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-webdriver-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-webdriver-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-webdriver` can be installed with:

```
conda install r-webdriver
```

It is possible to list all of the versions of `r-webdriver` available on your platform with:
